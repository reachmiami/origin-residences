...
export const amenitiesCopy: Record<Locale, AmenitiesCopy> = {
  en: {
    ...
    schedule: [
      '27 Unique residences',
      '2 bedroom to 4 bedroom',
      ...
      'Points available for connection of electric vehicle charging stations',
  ...
  es: {
    ...
    schedule: [
      '27 residencias únicas',
      'De 2 a 4 habitaciones',
      ...
      'Puntos disponibles para conexión de cargadores de vehículos eléctricos',
      'Zona de guardado de bicicletas',
  ...
  'pt-br': {
    ...
    schedule: [
      ...
      'Pontos disponíveis para instalação de carregadores de veículos elétricos',
      'Bicicletário',
